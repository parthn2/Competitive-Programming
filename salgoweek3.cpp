...
//// For question number 2 at every call swap the last element of the subarray with the first element
//
//void quicksort(int A[], int low, int high, int *count)
//{
//    if(high > low)
...
//
//// For question number 3, just find the midian of low, high and middle element of array and swap it with the first and perform quicksort function
//
//void quicksort(int A[], int low, int high, int *count)
//{
//    if(high > low)
